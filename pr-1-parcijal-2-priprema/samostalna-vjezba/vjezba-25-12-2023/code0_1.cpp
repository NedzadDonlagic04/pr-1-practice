...
ova 3 niza, tj. da se grupisu podatci duzine niza i clanova niza pod
strukturu, to da li ce se unos raditi preko metode unutar strukture ili
vanjske funkcije (ili bilo koje druge radnje) ostavljam do osobe koja
radi.
